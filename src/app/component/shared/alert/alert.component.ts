...
import { Alert } from 'src/app/model/class/alert/alert';
import { AlertType } from 'src/app/model/enum/alert/alert-type';
...
export class AlertComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        // if (history.state['key'] == 'Profile is deleted successfully') {
        //     this.alertService.success(history.state['key'], this.options);
        //     // this.id = history.state['key'];
        // }
