...
@Component({
  selector: 'app-amount-procedure',
  templateUrl: './amount-procedure.component.html',
  styleUrls: ['./amount-procedure.component.scss'],
})
export class AmountProcedureComponent implements OnInit {
